...
SECRET_KEY = 'django-insecure-&=1w!47kgy1@^a@zl!#h_%bz2+8bzeaw26d54##qdjauu0@q(f'
...
DATABASES = {
    'default': {
        ...
        'NAME': 'snippets',  # Name of your PostgreSQL database
...
SIMPLE_JWT = {
    'ACCESS_TOKEN_LIFETIME': timedelta(days=1),  # Set access token lifetime to 1 minutes
